...
@Component({
  selector: 'app-fashion-description',
  templateUrl: './fashion-description.component.html',
  styleUrls: ['./fashion-description.component.css']
})
export class FashionDescriptionComponent implements OnInit {
   id : any=null;
